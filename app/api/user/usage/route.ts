...
import { getMonthlyUsage, MONTHLY_SPEND_CAP_USD, getCurrentPeriod } from '@/lib/db/usage'
...
export async function GET(req: Request) {
  try {
    ...
    return handleApiError(err instanceof Error ? err : new ApiError('Failed to load usage', 500))
  }
}
