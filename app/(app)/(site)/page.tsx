...
function GetStarted() {
	return (
		<div className="flex flex-col items-center text-center">
			...
			<Link
				href="/build/new"
				className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium rounded-lg bg-nova-violet text-white hover:bg-nova-violet-hover shadow-[var(--nova-glow-violet)] transition-all duration-200"
			>
