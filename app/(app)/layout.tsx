...
export default function AppLayout({ children }: { children: React.ReactNode }) {
	return (
		...
		>
			...
			<a
				href="#main-content"
				className="sr-only focus:not-sr-only focus:absolute focus:z-system focus:top-2 focus:left-2 focus:px-4 focus:py-2 focus:rounded-lg focus:bg-nova-action focus:text-nova-action-ink focus:text-sm focus:font-medium focus:outline-none"
			>
