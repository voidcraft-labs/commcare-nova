	...
	return (
		<div>
			<input
				...
				autoComplete="off"
				data-1p-ignore
				className={`nova-focusable w-full min-h-11 px-3.5 py-2 rounded-lg bg-pv-input-bg border text-sm text-nova-text placeholder:text-nova-text-muted outline-none transition-colors ${
