...
export const tablerCredits: IconifyIcon = {
	width: 24,
	height: 24,
	body: '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 14a6 2 0 1 0 12 0a6 2 0 1 0-12 0"/><path d="M3 14v5c0 1.105 2.686 2 6 2s6-.895 6-2v-5M9 5a6 2 0 1 0 12 0A6 2 0 1 0 9 5m0 0v3"/><path d="M18.365 11.656C19.955 11.296 21 10.69 21 10V5"/></g>',
};
