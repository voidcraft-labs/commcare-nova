...
- **Logic tab** (`ContextualEditorLogic`) — required (Toggle + optional conditional XPath, hidden until added via "Add Property"), validation, relevant, default_value, calculate
