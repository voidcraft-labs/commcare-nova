	...
	return (
		<>
			<button
				...
				disabled={running}
				className={`inline-flex items-center justify-center gap-2 px-4 min-h-11 text-[13px] font-medium rounded-lg bg-nova-violet/[0.15] border border-nova-violet/[0.35] text-nova-violet-bright not-disabled:hover:bg-nova-violet/[0.25] transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed ${className}`}
			>
				<Icon
