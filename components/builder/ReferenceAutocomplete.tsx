...
const NAMESPACE_OPTIONS: Array<{ type: ReferenceType; label: string; description: string }> = [
...
export const ReferenceAutocomplete = forwardRef<ReferenceAutocompleteHandle, ReferenceAutocompleteProps>(
  function ReferenceAutocomplete({ items, showNamespaces, onSelectNamespace, onSelect }, ref) {
