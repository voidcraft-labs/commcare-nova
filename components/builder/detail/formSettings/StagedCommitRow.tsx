	...
	return (
		<div className="flex items-center justify-between gap-2 pt-0.5">
			...
			<button
				...
				onClick={onCommit}
				disabled={!ready}
				className="px-2.5 py-1 text-[11px] font-medium rounded-md bg-nova-violet text-white transition-colors enabled:hover:brightness-110 enabled:cursor-pointer disabled:opacity-40"
			>
				Add
			</button>
		</div>
