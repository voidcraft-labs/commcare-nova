  ...
  return (
    ...
    >
      ...
      <div className="relative w-5 h-5">
        ...
        >
          <div
            className="absolute -top-[2.5px] left-1/2 -translate-x-1/2 w-[5px] h-[5px] rounded-full bg-nova-violet shadow-[0_0_8px_rgba(139,92,246,0.6)]"
          />
        </motion.div>
        <div className="absolute inset-[5px] rounded-full bg-nova-violet/10" />
      </div>
