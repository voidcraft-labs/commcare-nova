...
export const PromptInputTextarea = ({
	...
	return (
		<InputGroupTextarea
			// Nova input convention: disable browser autofill / password-manager
...
export const PromptInputSubmit = ({
	...
	if (status === "submitted") {
		...
		statusIcon = <Icon icon={tablerPlayerStopFilled} className="size-4" />;
	...
	return (
		<InputGroupButton
			...
			className={cn("text-nova-violet-bright", className)}
			onClick={handleClick}
			size={size}
