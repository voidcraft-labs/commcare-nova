...
2. **Reference data** — the tree ships to devices as a fixture; forms and case lists query it for names, ids, level codes, `{level_code}_id` lineage attributes, and `<location_data>` children (§5).
