...
Before it actually uploads, Claude shows you the target project space — if your API key (saved in [Nova settings](https://commcare.app/settings)) reaches more than one, it asks which one — and asks you to confirm. Decline to back out without uploading.
