...
| Tool | What it does |
|---|---|
| `add_case_list_column` | Add one column to the case list (plain / date / phone / id-mapping / image-map / interval / calculated). |
...
| `remove_media_asset` | Delete a file from your library. Refuses if the current app still uses it. |
