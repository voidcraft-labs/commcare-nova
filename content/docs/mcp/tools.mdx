...
| Tool | What it does |
|---|---|
| `create_app` | Create a new empty app in **Draft** status and return its ID. Build it up with the other tools, then finish it with `complete_build`. |
...
| Tool | What it does |
|---|---|
| `complete_build` | Finish the build: run the full app review (every rule, including unfinished pieces and attached media) and mark the app Complete. Anything still unfinished comes back as a list — your agent finishes that work and calls again. |
