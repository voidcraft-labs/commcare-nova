...
| Tool | What it does |
|---|---|
| `add_case_list_column` | Add one column to the case list (plain / date / phone / id-mapping / interval / calculated). |
...
| `add_search_input` | Add one search input (simple property bind or advanced predicate). |
