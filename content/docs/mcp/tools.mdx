...
| `plan_app_design` | Plan the app design: modules, forms, purposes, per-form design notes (and Connect settings on Connect apps). Run after `generate_schema`; changes nothing. |
