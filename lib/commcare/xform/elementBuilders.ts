/**
 * Shared `domhandler` element + text constructors and serializer options used by
 * every XForm-emitting module in this package (`xform/builder.ts`,
 * `xform/metaBlock.ts`, `xform/caseBlocks.ts`).
 *
 ...
 * (`validator/xformOracle.ts` re-parses what these emitters produce).
 */

import { type ChildNode, Element, Text } from "domhandler";

/**
 * Build an XForm element with raw attribute values and optional element
