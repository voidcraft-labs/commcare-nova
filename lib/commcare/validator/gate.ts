...
> = {
	...
	FORM_LINK_DATUM_INCOMPLETE: "soundness",
	FORM_LINK_CONDITION_ALWAYS_FALSE: "soundness",
	FORM_LINK_CONDITION_CASE_DATA_UNAVAILABLE: "soundness",
	FORM_LINK_CONDITION_SEARCH_INPUT_UNAVAILABLE: "soundness",
	FORM_LINK_CONDITION_TYPE_ERROR: "soundness",
	FORM_LINK_CONDITION_NOT_ON_DEVICE: "soundness",
...
export function errorIdentity(err: ValidationError): string {
	...
	switch (err.code) {
		...
		case "CASE_LIST_SEARCH_INPUT_DEFAULT_CASE_DATA_UNAVAILABLE":
