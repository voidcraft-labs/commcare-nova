/**
 * Exact UTF-8 contents of CommCare HQ's accepted external-ID form fixture:
 *
 * `commcare-hq/corehq/apps/app_manager/tests/data/form_preparation_v2/open_case_external_id.xml`
 *
 * `FormPreparationV2Test.test_open_case_external_id` prepares this form and
 * pins that a registration external ID is an `<update>` child, never part of
 * `<create>`. Keep the closing backtick on the same line as `</h:html>`: the
 * upstream 3835-byte fixture has no final newline.
 */
export const CCHQ_OPEN_CASE_EXTERNAL_ID_XML = `<?xml version="1.0"?>
<h:html xmlns:h="http://www.w3.org/1999/xhtml" xmlns:orx="http://openrosa.org/jr/xforms" xmlns="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:jr="http://openrosa.org/javarosa">
    <h:head>
        ...
        <model>
            ...
            <setvalue ref="/data/case/@case_id" event="xforms-ready" value="instance('commcaresession')/session/data/case_id_new_test_case_type_0"/>
