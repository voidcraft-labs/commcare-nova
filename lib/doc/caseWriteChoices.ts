 ...
 *
 * A destination is always one whole `{ caseType, property }` pair (or null to
 * clear). Declaration and field retargeting share the batch, matching the
 * builder mutation hook's declaration chokepoint.
 */
