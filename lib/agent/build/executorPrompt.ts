...
1. **Implement the accepted workflow slice.** Build it completely in the design's own terms — a real working piece of the app, not a sketch or a scaffold. Prerequisite workflows are context; do not re-create them.
