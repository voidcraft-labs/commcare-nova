...
Its internal lineage bindings never become model arguments. The isolated pilot
under `authoring/experimental` remains research evidence. Read `authoring/CLAUDE.md` and the delivery plan before extending the boundary.
