...
Edit the shared plan where you can make a clear improvement. Update the relevant passages and remove resolved concerns; review history belongs in your closing message. Preserve sound decisions and stay within the user's intent. End with a concise explanation of material changes, remaining concerns, and what you inspected or exercised. Distinguish evidence from inference.`,
	},
];
