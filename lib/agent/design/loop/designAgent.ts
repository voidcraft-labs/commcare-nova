...
export function createDesignAgent(args: DesignAgentArgs) {
	...
	const refineToolInput = {
		...
		inspectProjectData: registerToolInput("inspectProjectData"),
		...
		updateLookupTables: registerToolInput("updateLookupTables"),
