...
export const setDesignRootInputSchema = z
	...
	.refine((value) => Object.keys(value).length > 0, {
		message: "Set the contract name or its complete charter.",
	});
...
/** Old operations remain in retired sessions and never enter current replay. */
export function parseStoredDesignArtifactWorkspaceOperation(
	stored: unknown,
