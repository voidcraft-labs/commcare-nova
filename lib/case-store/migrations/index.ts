...
import * as betterAuth17CompatibilityFunctions from "./20260829000000_better_auth_17_compatibility_functions";
...
export const caseStoreMigrations: Record<string, Migration> = {
	...
	"20260829000000_better_auth_17_compatibility_functions":
		betterAuth17CompatibilityFunctions,
};
