...
import * as reviewedBlueprintCandidates from "./20260811000000_reviewed_blueprint_candidates";
...
export const caseStoreMigrations: Record<string, Migration> = {
	...
	"20260811000000_reviewed_blueprint_candidates": reviewedBlueprintCandidates,
};
