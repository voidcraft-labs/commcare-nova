...
export const FROZEN_STORAGE_OCCURRENCES = [
	...
	{
		id: "accepted_mutations.before-new-horizon",
		table: "accepted_mutations",
		path: "mutations",
		disposition: "opaque-pre-horizon",
		semantic: "mutation",
	},
	{
		id: "accepted_mutations.new-horizon-and-suffix",
		table: "accepted_mutations",
		path: "kind|mutations",
		disposition: "preserve-exact",
		semantic: "mutation",
	...
	},
	{
		...
		table: "threads",
		path: "messages[].parts[].metadata.attachments[].assetId",
		disposition: "rewrite-current",
		semantic: "attachment",
	},
	{
