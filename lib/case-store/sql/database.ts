...
/**
 * Failed-migration sink. Spec § "Schema migration policy" (lines
 * 309-340). `applySchemaChange` writes here when a blueprint
 * mutation produces a value the new schema rejects; the original
 * row stays preserved verbatim for author-UI review.
 *
