...
// migrations live under `lib/case-store/migrations/` (autogenerated
// SQL files atlas applies); the desired-state schema source is
// `lib/case-store/schema.sql`. Sample-data seeding and the case-
// store query surface live in other `lib/case-store/` siblings.
// The only export here is the type contract; the runtime behavior
// composes on top.
