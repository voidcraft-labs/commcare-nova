...
4. **After all questions are answered**, output a single brief confirmation (e.g. "Got it — generating your app now.") and then call scaffoldBlueprint. Do not summarize, list requirements, or output markdown — just a short one-sentence acknowledgment before the tool call.
