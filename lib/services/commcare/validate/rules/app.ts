...
export function emptyAppName(blueprint: AppBlueprint): ValidationError[] {
  if (!blueprint.app_name || !blueprint.app_name.trim()) {
    return [validationError('EMPTY_APP_NAME', 'app',
...
export function duplicateModuleNames(blueprint: AppBlueprint): ValidationError[] {
...
export function childCaseTypeMissingModule(blueprint: AppBlueprint): ValidationError[] {
