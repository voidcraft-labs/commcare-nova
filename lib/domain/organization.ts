...
const NO_LEVELS: Record<string, OrganizationLevel> = {};
const NO_PROPERTIES: Record<string, LocationProperty> = {};

export function organizationLevelsOf(
	doc: OrganizationCollections,
): Record<string, OrganizationLevel> {
	return doc.organizationLevels ?? NO_LEVELS;
}

export function locationPropertiesOf(
	doc: OrganizationCollections,
): Record<string, LocationProperty> {
	return doc.locationProperties ?? NO_PROPERTIES;
}
