...
Transient UI state scoped to the builder route: preview mode, sidebar visibility, agent run status, active field, connect-mode stash. None of it is undoable; none of it persists across page loads.
