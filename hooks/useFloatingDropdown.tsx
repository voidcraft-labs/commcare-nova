...
export function useFloatingDropdown<T extends HTMLElement = HTMLElement>(
	...
	return {
		...
		contentRef,
		floatingStyles,
	} satisfies FloatingDropdown<T>;
}

// ── Portal wrapper ───────────────────────────────────────────────────

interface DropdownPortalProps<T extends HTMLElement>
	extends Omit<React.HTMLAttributes<HTMLDivElement>, "ref" | "style"> {
